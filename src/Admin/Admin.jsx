...
//               <Link className="nav-link " to="/TaskReport">Reports</Link>
//             </li>
//             <li className='dd_navHav'>
...
//             </li>
//             <li className='dd_navHav'>
//               <Link className="nav-link " to="/Managerhompage">Manager</Link>
//             </li>
//             <li className='dd_navHav'>
...
const Admin = ({ Parent }) => {
  ...
  useEffect(() => {
   ...
   const fetchData = async () =>{
    try{
      const first = await axios.get('http://localhost:8068/projects');
      const second = await axios.get('http://localhost:8081/api-v2/employees');
      const thored = await axios.get('http://localhost:8080/api/departments');
      const forth = await axios.get('http://localhost:8080/api/tasks/all');
      const fifth = await axios.get('http://localhost:8080/api/task-status/all');
   ...
   const [options, setOptions] = useState({
    ...
    xaxis: {
      categories: ["Projects", "Employees", "Departments", "Tasks", "Task Statuses"]
    },
    yaxis: {
      title: {
        text: 'Count'
  ...
  }, [projectLenth, employeeLenth, DeportmentLenth, TaskDeportment, TaskStatusLenth]);
        ...
        <div className="bodyy row mt-2 ms-3">
         ...
         <div className="row">
             ...
             <div className="col-6 col-sm-4 col-lg-4 border2">
                 ...
                 <div className="d-flex position-relative m-3">
                     ...
                     <div>
                     <span className="text">
                         <h3 className="text-danger">{projectLenth}</h3>
                         <p><Link className='link-underline link-underline-opacity-0' to="/#">Projects</Link></p>
                     </span>
             ...
             <div className="col-6 col-sm-4 col-lg-4 border2">
                 ...
                 <div className="d-flex position-relative m-3">
                     ...
                     <div>
                     <span className="text">
                         <h3 className="text-danger">{employeeLenth}</h3>
                         <p><Link className='link-underline link-underline-opacity-0' to="/#"> Employees </Link></p>
                     </span>
            ...
            <div className="d-flex position-relative m-3">
                ...
                <div>
                <span className="text">
                    <h3 className="text-danger">{DeportmentLenth}</h3>
                    <p><Link className='link-underline link-underline-opacity-0' to="/#">Deportments</Link></p>
                </span>
         ...
         <div className="row mb-2">
             <div className='col-12 col-sm-4 col-lg-6 areygrap'>
                 ...
                 <div className='line-chart mt-2' id="chart">
                  <Chart
                    options={options}
                    series={series}
                    type="line"
            ...
            <ul >
             <li className="bordersid list-group-item">
                 <div className="d-flex position-relative m-2">
                     ...
                     <div>
                         <span className="text">
                             <h3 className="text-danger">{TaskStatusLenth}</h3>
                             <p><Link className='link-underline link-underline-opacity-0' to="/#">TaskStatus </Link></p>
                         </span>
                     </div>
                </div>
             </li>
             ...
             <li className="bordersid list-group-item">
                 <div className="d-flex position-relative m-2">
                     ...
                     <div>
                         <span className="text">
                             <h3 className="text-danger">{TaskDeportment}</h3>
                             <p><Link className='link-underline link-underline-opacity-0' to="/#">Tasks </Link></p>
                         </span>
                     </div>
                </div>
             </li>
