        ...
        <ul >
          <li className="list-group-item secondpart">
            ...
            <div className='d-flex dd_graps'>
              ...
              <span className='ms-5 ps-4'>Projent&nbsp;Members</span>
        ...
        <div className='col-6 col-sm-3 col-lg-3  m-1'>
         <ul>
          <li className='list-group-item thirdpart'>
            <b className='text-danger fs-4'>Financial Repor</b>
            <div className='m-2'>
            ...
            <button type="button" class="btn btn-primary">Financial Repor</button> 
            </div>
          </li>
          <br />
          <li className='list-group-item thirdpart'>
