...
const EmployeeList = () => {
  ...
  return (
    <div className="container mt-4"  style={{marginLeft:"20%"}}>
      <h2>Employee List</h2>
        ...
        <Modal.Body>
          <Form>
            ...
            <Form.Group controlId="formName">
              ...
              <Form.Control type="text" placeholder="Enter Role" value={updatedRole} onChange={(e) => setUpdatedRole(e.target.value)} />
            </Form.Group>
